...
class UserServiceImplCoverageTest {
    ...
    // Vamos a usar spy para stubear callFirebaseAuth y addUserToDb
    ...
    void setUp() {
        ...
        // (en vez de llamar init() y setear apiKey)
    ...
    void emailLogin_shouldThrowAuthenticationServiceException_whenResponseNullOrMissingIdToken(){
        ...
        // Caso: response null
        doReturn(null).when(service).callFirebaseAuth(eq("http://firebase/password"), anyMap());
    ...
    void emailLogin_shouldCallAddUserToDb_whenUserNotExists() throws Exception {
        ...
        doReturn(firebaseResp).when(service).callFirebaseAuth(eq("http://firebase/password"), anyMap());
        ...
        when(modelMapperUtils.map(userEntity,
                com.techforb.apiportalrecruiting.modules.backoffice.user.dtos.UserLoginResponseDTO.class))
                .thenReturn(mock(com.techforb.apiportalrecruiting.modules.backoffice.user.dtos.UserLoginResponseDTO.class));
    ...
    void googleLogin_shouldThrowAuthenticationServiceException_whenFirebaseCallThrowsRestClientException() {
        doThrow(new RestClientException("firebase down"))
                .when(service).callFirebaseAuth(eq("http://firebase/provider"), anyMap());
    ...
    void googleLogin_shouldThrowAuthenticationServiceException_whenResponseMissingIdToken() {
        ...
        doReturn(resp).when(service).callFirebaseAuth(eq("http://firebase/provider"), anyMap());
    ...
    void changePassword_shouldThrowAuthenticationServiceException_whenFirebaseCallThrowsRestClientException() {
        ...
        doThrow(new RestClientException("boom"))
                .when(service).callFirebaseAuth(eq("http://firebase/password"), anyMap());
